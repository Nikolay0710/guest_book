...
<?php endif; ?>
<form action='/' method="POST" name='form_guest_book' id='form_guest_book'>
	<table class='table'>
		<tr>
		...
		<tr>
			<td class='w'><label for='homepage'>Homepage:</label></td>
		...
		<tr>
			...
			<td><input id='text' id='tegs' name='meta' required></td>
			<td>Теги, ключевые слова сообщения.</td>
		</tr>
		<tr>
			<td class='w c'><?=$a?> + <?=$b?> = <span class='red'>*</span></td>
			<td><input type='text' name='captcha' id='captcha' placeholder='?' required></td>
			<td>Введите код, изображенный на картинке.</td>
		</tr>
		<tr>

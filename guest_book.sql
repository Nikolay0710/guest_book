...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июл 04 2019 г., 20:26
...
(47, 'Nikolay', 'ooo19920710@mailru', 'gfhghgh', 'http://', '2019-07-04 20:05:04', 'dsgds'),
...
(1, 'Homepage', 'Homepage', 'makeup_22.png', 'images.png', 'Homepage', '<h1>Fusce Eleifend Posuere Nibsor</h1>\n				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce eleifend posuere nibh, \n				ut tincidunt est pretium vitae. Suspendisse dapibus arcu in tortor scelerisque volutpat. \n				In imperdiet, lectus eu gravida vestibulum, orci bamte nibehre ustiyep malesuada nunc, \n				lobortis commodo lorem ipsum a quam...<a href="#">Continue Reading</a></P>\n\n', 'no name'),
...
(4, 'About Me', 'About Me', 'makeup_28.png', '5d1444672b-aboutus-main.jpg', 'About', 'Lorem Ipsum - это текст-"рыба", часто используемый в печати и вэб-дизайне. Lorem Ipsum является стандартной "рыбой" для текстов на латинице с начала XVI века. В то время некий безымянный печатник создал большую коллекцию размеров и форм шрифтов, используя Lorem Ipsum для распечатки образцов. Lorem Ipsum не только успешно пережил без заметных изменений пять веков, но и перешагнул в электронный дизайн. Его популяризации в новое время послужили публикация листов Letraset с образцами Lorem Ipsum в 60-х годах и, в более недавнее время, программы электронной вёрстки типа Aldus PageMaker, в шаблонах которых используется Lorem Ipsum.', 'no name'),
...
--
ALTER TABLE `book`
  MODIFY `id` tinyint(12) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=48;
--
